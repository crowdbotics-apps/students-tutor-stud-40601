"""
Django settings for students_tutor_stud_40601 project.
...
ROOT_URLCONF = 'students_tutor_stud_40601.urls'
...
WSGI_APPLICATION = 'students_tutor_stud_40601.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "students_tutor_stud_40601 API",
    "DESCRIPTION": "API documentation for students_tutor_stud_40601 App",
    "VERSION": "v1",
}
