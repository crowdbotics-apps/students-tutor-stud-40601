...
## Project Structure
    ...
    ├── students_tutor_stud_40601  # Django project configurations
...
1. Clone this repo and `cd students_tutor_stud_40601`
...
2. Clone this repo and `cd students_tutor_stud_40601`
